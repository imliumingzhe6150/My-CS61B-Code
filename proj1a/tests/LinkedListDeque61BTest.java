...
public class LinkedListDeque61BTest {
    ...
    @Test
     public void IsemoptyAndSizetest() {
         Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
    ...
    @Test
     public void testGet() {
         ...
         assertThat(lld1.get(12334)).isNull();

         Deque61B<String> empty = new LinkedListDeque61B<>();
    ...
    public void testRecursiveGet() {
        ...
        assertThat(lld1.getRecursive(2)).isEqualTo("front");

        assertThat(lld1.getRecursive(-1)).isNull();
        assertThat(lld1.getRecursive(3)).isNull();
        assertThat(lld1.getRecursive(12334)).isNull();

        Deque61B<String> empty = new LinkedListDeque61B<>();
        assertThat(empty.getRecursive(0)).isNull();
    }
}